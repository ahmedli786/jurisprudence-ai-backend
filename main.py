...
logger = logging.getLogger("jurisprudence-ai")
...
LEGAL_KB = {
    ...
    "threat_remedy": {
        "answer": "<strong>What to Do After Receiving a Threat?</strong><br><br><strong>Immediate Steps:</strong><br><br><strong>1. Document Everything</strong><br>• Save messages, screenshots, recordings<br>• Note date, time, place, witnesses<br>• Keep call records<br><br><strong>2. File Police Complaint (FIR)</strong><br>• Go to nearest police station<br>• File FIR under <strong>Section 506 IPC</strong> (Criminal Intimidation)<br>• If death threat: <strong>Section 506 Part II</strong> (up to 7 years)<br>• Get FIR copy<br><br><strong>3. Additional Sections (if applicable):</strong><br>• <strong>Section 503</strong>: Criminal intimidation<br>• <strong>Section 507</strong>: Anonymous threats<br>• <strong>Section 509</strong>: If against woman's modesty<br>• <strong>IT Act Section 66A</strong>: Online threats<br><br><strong>4. Protection Orders:</strong><br>• Apply for <strong>protection under DV Act</strong> (if domestic)<br>• File for <strong>restraining order</strong> in civil court<br><br><strong>5. Safety Measures:</strong><br>• Inform family and friends<br>• Avoid being alone<br>• Install security cameras if possible<br>• Change daily routine if needed<br><br><strong>Emergency:</strong> Call <strong>100</strong> (Police) or <strong>112</strong> (Emergency)",
        "hindi": "धमकी मिलने पर: 1) सबूत सुरक्षित करें (स्क्रीनशॉट, रिकॉर्डिंग), 2) धारा 506 के तहत FIR दर्ज करें, 3) जान की धमकी पर 7 साल तक सजा। आपातकाल: 100 या 112 पर कॉल करें।",
        "citations": [{"section": "Section 506", "act_name": "IPC, 1860", "relevance_score": 0.97}, {"section": "Section 503", "act_name": "IPC, 1860", "relevance_score": 0.93}],
        "followups": ["How to file FIR for threat?", "Online threat complaint?", "What is Section 506?"]
    },
    "ipc_323": {
...
def find_knowledge(query):
    ...
    if "threat" in q or "threaten" in q or "blackmail" in q:
        return LEGAL_KB["threat_remedy"]
...
if __name__ == "__main__":
    ...
    logger.info(f"Starting Jurisprudence AI on port {port}")
